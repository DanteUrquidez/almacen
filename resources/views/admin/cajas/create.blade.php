...
@section('title', 'Crear Caja / Packing List')

@section('content')
<div class="section">
    <div class="section-header">
        <h1>Crear Caja / Packing List</h1>
    </div>
                                ...
                                <select name="serial" id="serial" class="form-control" required>
                                    ...
                                    @foreach($almacenes as $almacen)
                                        <option value="{{ $almacen->id }}"
                                            ...
                                            {{ old('serial') == $almacen->id ? 'selected' : '' }}>
                            ...
                            <div class="items-container">
                                <div class="row mb-2 item-row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" step="any" name="cajas[0][items][0][pkg_weight]" class="form-control">
                                    </div>
                                </div>
